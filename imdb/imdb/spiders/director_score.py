...
def prepare_movie_urls():
    """
        准备movie url
    """
    search_result = imdbpipeline.get_actor_id(type_id=2) 
...
class DirectorScoreSpider(scrapy.Spider):
    name = 'director_score'
